...
1. Right-click **Copy Course** and open the link in a new tab.
   ...
   <a id="copy-course" href="https://github.com/new?template_owner=chriswblake&template_name=introduction-to-github&owner=%40me&name=skills-introduction-to-github&description=My+Course:+Get+started+using+GitHub&visibility=public">
